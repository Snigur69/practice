...
if ( ! function_exists( 'landing_setup' ) ) :
	...
	function landing_setup() {
		 ...
		 */
		add_image_size('post_thumb', 800, 400);
...
function landing_scripts() {
	...
	wp_enqueue_style('open-sans', 'https://fonts.googleapis.com/css?family=Open+Sans:400,600,600i,700i,800,800i');
	wp_enqueue_style('fontawesome', 'https://use.fontawesome.com/releases/v5.8.0/css/all.css');
